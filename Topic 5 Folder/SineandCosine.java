...
import javafx.scene.test.Text;
import javafx.stage.Stage;

public class SineandCosine extends Application {
//14.19 Plot the sine and cosine
	...
	public void start(Stage primaryStage) throws Exception {
		...
		String[] pi = new String[] {"-3\u03c0", "-2\u03c0", "-u03c0", "0", "\u03c0", "2\u03c0", "3\u03c0"};
	...
	private staic void drawXAxis(Pane pane, Polyline xAxis) {
