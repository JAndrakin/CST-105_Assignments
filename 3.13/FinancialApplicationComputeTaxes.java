	...
	public static void main(String[] args) {
		...
		if (status ==0) { // Compute tax for single filers
			...
			if (income <= 16700)
				...
				tax = 16700 * 0.10 + (income - 16700) * 0.15 + (income - 67900)
				* 0.25;
				...
				* 0.25 + (208850 - 137050) * 0.28 + (income - 208850) * 0.33;
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900)
				* 0.25 + (208850 - 137050) * 0.28 + (372950 - 208850) * 0.33 + (income - 372950) * 0.35;
			}
		else if (status == 2) { // Compute tax for married separately
			if (income <= 8350) tax = income * 0.10;
			else if (income <= 8350) tax = 8350 * 0.10 + (income - 8350) * 0.15;
			...
			else tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28 + (372950 - 45500) * 0.25 + 
