...
public class DisplayARectanguloid {
	//14.14
	@Override
	public void start(Stage primaryStage) {
		...
		rec2.xProperty().bind(pane.widthProperty().divide(4).subtract(25));
		rec2.yProperty().bind(pane.heightProperty().divide(4).add(25));
		...
		lien2.startYProperty().bind(rec1.yProperty().add(rec1.heightProperty()));
